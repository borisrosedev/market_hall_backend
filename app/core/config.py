...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "Market Hall API"
    ...
    FIRST_SUPERUSER: EmailStr = "boris@gmail.com"
    FIRST_SUPERUSER_PASSWORD: str = "caroline123"

    def _check_default_secret(self, var_name: str, value: str | None) -> None:
        if value == "carolineisthequeen":
            message = (
                f'The value of {var_name} is "carolineisthequeen", '
                "⚠️ I did not change it yet but it must be changed before prod deployment"
            )
