...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.Enum("created", "paid", "failed", name="statusorders"), nullable=False
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("user_id", sa.UUID(), nullable=True),
    ...
    op.create_index(
        op.f("ix_tag_products_product_id"), "tag_products", ["product_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_cart_products_product_id"), "cart_products", ["product_id"], unique=False
    )
    op.create_table(
        "order_addresses",
        sa.Column(
            "type", sa.Enum("shipping", "billing", name="typeorderaddresses"), nullable=False
        ),
